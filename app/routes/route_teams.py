...
"""Arreglar que cuando la hora inicio sea mayor a la hora fin que no se agregue el equipo Puede que en lugar de un redirect mejor usar un render_template"""
